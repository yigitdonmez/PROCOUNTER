...
public partial class MainPage : ContentPage, INotifyPropertyChanged
{
    ...
    {
        string settingsAction = await DisplayActionSheetAsync(AppResources.Settings, AppResources.Cancel, null, AppResources.Language);

        if (settingsAction == AppResources.Language)
        {
            string langAction = await DisplayActionSheetAsync(AppResources.Language, AppResources.Cancel, null, "English", "Türkçe");
